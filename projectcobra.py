...
medio = ["idade", "igreja", "sextou", "saudade",
         "serpente", "nostalgia", "algoritimos"]
dificil = ["paralelepipedo", "desenvolvimento", "otorrinolaringologista",
           "desproporcionadamente", "contrarrevolucionario", "newtoniano", "onomatopeia"]
...
while op == 1:
    ...
    dif = int(input(
        'Digite a dificuldade na qual você quer jogar \n\n1 - Facil \n2 - Medio \n3 - Dificil \n'))
